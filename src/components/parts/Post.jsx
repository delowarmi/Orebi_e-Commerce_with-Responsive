...
const Post = ({allData,cetagorysearchFilter,brandsearchFilter,filterprice,colList,products}) => {
    ...
    <div> 
      ...
      <div className={ `${colList== 'Activelist'?'gap-x-10  flex-col':'gap-x-10 flex flex-wrap'}`}>
         ...
         <div className='w-full lg:w-[270px] pt-16'>
           ...
           <button onClick={handlbrandeshow} className=' font-bold py-2 px-6 bg-gray-500 font-dm text-red-700'>See All</button>
           :
           <button onClick={handlebrandhide} className=' font-bold py-2 px-6 bg-gray-500 font-dm text-red-700'>See Less</button>
           }
           </div>
           </div>
          :
