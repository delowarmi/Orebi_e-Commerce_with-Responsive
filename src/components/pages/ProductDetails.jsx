...
const ProductDetails = () => {
  ...
  let [activeColor, setActiveColor] = useState(null); //color active
  //-----------add to cart , incriement, dicriment----------
  let handleAddToCart = () => {
  ...
  //--------------end-------------------
  // client rating but it's dot'n work
                  ...
                  <Flex className={"gap-x-2 mt-1 h-8"}>
                    <div className=" flex gap-x-2 mt-1">
                      {[
                        ...
                        <div
                          key={color}
                          className={`w-5 h-5 rounded-full cursor-pointer transition-all duration-200 ${activeColor === color ? "w-7 h-7 border-2 border-black" : ""}`}
            ...
            <Flex className={"justify-between"}>
              <div className="lg:w-[277px] pt-5">
                <Flex className={" gap-x-3 lg:gap-x-7"}>
                  ...
                  />
                  <Flex className={"lg:gap-x-2 pt-1"}>{clientrating}</Flex>
                </Flex>
              </div>
              <Heading
                as={"h3"}
